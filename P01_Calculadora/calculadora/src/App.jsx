    ...
    <div className='container'>
      <div className="content">
        ...
        <div className="calc-keyboard">
          ...
          {numbers.map((number) => (
            <Button key={number} value={number} handleClick={() => insertNumberOnEquation(number)} />
          ))}
          {operations.map((operation) => (
            <Button key={operation} value={operation} handleClick={() => insertOperationOnEquation(operation)} />
          ))}
